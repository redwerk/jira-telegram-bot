/start - start JiraBot
/listunresolved - show all unresolved issues
/liststatus - show users and projects issues with a selected status
...
/connect - login to a host using user/pass
/oauth - login to a host using OAuth
