    ...
    def handler(self, bot, update, *args, **kwargs):
        ...
        if options and filters:
            ...
            if filter_name in filters.keys():
                ...
                result['text'] = 'This filter is not in your favorites'
        elif filters:
            ...
            if buttons:
                result['text'] = 'Pick up one of the filters:'
                result['buttons'] = buttons
        else:
            result['text'] = "You don't have any favourite filters"
...
class FilterIssuesCommand(AbstractCommand):
    ...
    def handler(self, bot, update, *args, **kwargs):
        ...
        result['title'] = 'All tasks which filtered by «{}»:'.format(filter_name)
        result['items'] = self._bot_instance.jira.get_filter_issues(
            filter_id=filter_id, filter_name=filter_name, auth_data=auth_data
        )
        result['key'] = 'filter_p:{}:{}'.format(telegram_id, filter_id)
